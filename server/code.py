...
class Code_Work(object):
    ...
    def pull_code(self):
        ...
        if os.path.isdir('/mnt/work'):
            os.system('rm -rf /mnt/work/*')      #每次拉取,work都是干净目录
            os.chdir('/mnt/work')
        else:
            os.mkdir('/mnt/work')
            os.chdir('/mnt/work')
    ...
    def build_rpm(self):
        ...
        f_args = 'fpm -s dir -t rpm -n %s --epoch 0 -v %s -C /mnt/work -p /mirros/package %s' % (self.__pro,self.__ver,self.__tgt)
        try:
